...
const services = [
  {
    icon: <Egg size={60} className="text-green-600" />,
  ...
  {
    icon: <Drumstick size={60} className="text-green-600" />,
  ...
  // {
  //   icon: <LineChart size={60} className="text-green-600" />,
  ...
  // },
  {
    icon: <Tractor size={60} className="text-green-600" />,
  ...
  // {
  //   icon: <Activity size={60} className="text-green-600" />,
  //   title: "Organic Feed",
  //   description:
  ...
  // },
  {
    icon: <Binoculars size={60} className="text-green-600" />,
    title: "Farm Tours",
    description:
    ...
    <section className="py-20 bg-gray-50" id="services">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-md font-bold text-green-700 mb-2">
            OUR SERVICES
          </h2>
