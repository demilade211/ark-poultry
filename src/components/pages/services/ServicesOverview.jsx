...
const services = [{
  id: 'egg-production',
  icon: <Egg size={48} className="text-green-600" />,
  ...
  icon: <Drumstick size={48} className="text-green-600" />,
  ...
  id: 'poultry-supply',
  icon: <LineChart size={48} className="text-green-600" />,
  ...
  id: 'farm-tours',
  icon: <Binoculars size={48} className="text-green-600" />,
  title: 'Farm Tours',
              ...
              <div className="container mx-auto px-4">
                <div className={`grid grid-cols-1 lg:grid-cols-2 gap-12 items-center ${index % 2 === 0 ? '' : 'lg:flex-row-reverse'}`}>
                  <div className={`${index % 2 !== 0 ? 'lg:order-2' : ''}`}>
                    ...
                    <Link href="/contact" className="inline-block px-6 py-3 bg-green-600 text-white font-medium rounded-md hover:bg-green-700 transition-colors">
